...
@Composable
fun RecentPage(modifier: Modifier = Modifier, navController: NavController) {
    val scrollState = rememberScrollState()
    Scaffold(
        containerColor = Main,
        topBar = {
            TopBarHeader(navController = navController, name = "Recently Viewed")
        },
        bottomBar = {
            HomeMenu(navController = navController, currentpage = "recent")
        },
        content = {
            innerPadding->
            FlowRow(
